...
The post-v0.53 form-first surface contains exactly **1,336** named public Lean
theorems, ordered as `NCSW-001` through `NCSW-1336` in
...
| `NCSW-1319`–`NCSW-1336` | `Boundary/GreenHaarCameraForm.lean` | unique exact-norm extension of bounded core functionals, uniform isometric-atlas restrictions, compatible finite restrictions and the constant-one Naimark target for unit sources |
